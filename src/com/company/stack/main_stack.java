...
//        System.out.println(st.maxAreaNaive(new int []{6,2,5,4,1,5,6}));
//        System.out.println(st.maxAreaEff(new int[]{2,1,5,6,2,3}));
        System.out.println(st.infixToPostfix("a+(b/(c-d*e))"));
        System.out.println(st.infixToPostfix("(a+b)*c"));
    }
}
